...
public class CoronaCounter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corona_counter);
                            ...
                            try {
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        new AlertDialog.Builder(CoronaCounter.this)
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    @Override
                                    public void run() {
                                        Toast.makeText(CoronaCounter.this, "Network Connection Error!",
